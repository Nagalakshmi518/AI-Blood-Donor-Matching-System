...
async function loadMyRequests() {
  ...
  requestsContainer.innerHTML = `
    <p class="loading">Loading your blood requests...</p>
  `;
  ...
  try {
    ...
    if (!Array.isArray(data) || data.length === 0) {
      requestsContainer.innerHTML = `
        <p class="empty">No blood requests found.</p>
      `;
      return;
    }

    // Build complete HTML in memory first
    const requestsHTML = data
      .map((bloodRequest) => {
        const donors = Array.isArray(bloodRequest.matched_donors)
          ? bloodRequest.matched_donors
          : [];
        ...
        const validDonors = donors.filter((match) => {
          ...
          return (
            ...
            Number.isFinite(Number(donor.latitude)) &&
            Number.isFinite(Number(donor.longitude))
          );
        });
            ...
            ? donors
                ...
                <div class="donor-card">
                  ...
                  <div class="donor-card-header">
                    ...
                    <span class="response-status ${getResponseClass(
                      donorResponse,
                    )}">
                      ${donorResponse}
                    </span>
                  ...
                  <div class="donor-details">
                    ...
                    <p>
                      ...
                      <span>${donor.blood_group || "N/A"}</span>
                    </p>
        ...
        if (fulfillmentSource === "HOSPITAL_INVENTORY") {
          inventoryHTML = `
        ...
        <div class="request-card">
          ...
          <div class="request-details">
            ...
            <div>
              ...
              <span>${bloodRequest.units_needed}</span>
            </div>

            <div>
              <strong>Emergency Level</strong>
              <span>${bloodRequest.emergency_level}</span>
            </div>
